...
public class Util {
	...
	public static String getLimitString(String sql, Pagination pagination) {

		StringBuffer sb = new StringBuffer();

		sb.append(sql);

		sb.append(" limit  " + pagination.getCurrentPageNo() + " , "
...
//    	SimpleUser simpleUser = (SimpleUser) JSONObject.toBean((JSONObject) obj.get("obj"),SimpleUser.class);
//    	//////System.out.println(simpleUser.getId());
    	
   // 	JSONObject  obj1 = (JSONObject) obj.get("obj");
