...
layui.define(["element","laytpl" ,"jquery"], function (exports) {
    ...
    var miniMenu = {
        ...
        renderSingleModule: function (menuList, menuChildOpen) {
            ...
            $('.layuimini-menu-left1').html(leftMenuHtml);
        ...
        listen: function () {
            ...
            $('body').on('click', '[data-menu]', function () {
                ...
                // left
                $("layuimini-menu-left1 .layui-nav.layui-nav-tree.layui-this").addClass('layui-hide');
                $("layuimini-menu-left1 .layui-nav.layui-nav-tree.layui-this.layui-hide").removeClass('layui-this');
