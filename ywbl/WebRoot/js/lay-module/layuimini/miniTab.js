...
layui.define(["element", "layer", "jquery"], function (exports) {
    ...
    var miniTab = {
        ...
        create: function (options) {
            ...
            $('.layuimini-menu-left1').attr('layuimini-tab-tag', 'add');
        ...
        listen: function (options) {
            ...
            $('body').on('click', '[layuimini-href]', function () {
                ...
                var el = $("[layuimini-href='" + href + "']", ".layuimini-menu-left1");
             ...
             * 关闭tab右键菜单
             */
            $('body').on('click', '.layui-body,.layui-header,.layuimini-menu-left1,.layuimini-tab-make', function () {
                miniTab.closeTabRignMenu();
            });
        ...
        listenSwitch: function (options) {
            ...
            element.on('tab(' + options.filter + ')', function (data) {
                ...
                // 判断是否为新增窗口
                if ($('.layuimini-menu-left1').attr('layuimini-tab-tag') === 'add') {
                    $('.layuimini-menu-left1').attr('layuimini-tab-tag', 'no')
                } else {
                    ...
                    var addMenuClass = function ($element, type) {
                        if (type === 1) {
                            ...
                            if ($element.hasClass('layui-nav-item') && $element.hasClass('layui-this')) {
                                ...
                                $(".layuimini-menu-left1 .layui-nav.layui-nav-tree").attr('class', 'layui-nav layui-nav-tree layui-hide');
