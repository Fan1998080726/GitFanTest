...
<div class="main">
  ...
  <!--toolbar-->
   <div class="toolbar">
	...
	<input id="aa" type="button" onclick="getChildData();" style="background:url(<%=path%>/img/t-save.png) no-repeat; width:64px; height:25px; border:none; margin-bottom:10px;"/>
    <div class="clear"></div>
  </div>
          ...
          <table class="table table-striped table-bordered table-condensed">
            ...
            <c:forEach items="${list}" var="type" varStatus="stauts">
	              <tr <c:if test="${stauts.count%2==1 }">class="odd"</c:if>>
	             	<td style="background:#e3f3f9; border-right:1px solid #91abb9;"><input type="radio" value="${type.mt_id },${type.mt_name},${ type.ml_num }" name="selectFlag"></td>
	                <td>${ type.mt_name }</td>
