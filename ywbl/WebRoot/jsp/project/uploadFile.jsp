...
<%-- 	 <%@ include file="/jsp/common/common.jsp"%> --%>
	...
	<link href="css/layout.css" type="text/css" rel="stylesheet">
		<link href="css/bootstrap.min.css" type="text/css" rel="stylesheet">
			...
			<script src="<%=path%>/jsp/project/uploadFile.js"></script>
</head>
<style>
#bg{   
    display: none;   
...
<div class="main">
 ...
 <div align="right"	>
     ...
     <button type="button" 	onclick="ajaxSubmit()"	class="layui-btn layui-btn-normal">
		...
		<form id="filesForm" enctype="multipart/form-data" 				method="post" action="filesUpload!uploadFiles.action">
			<table align="center"      class="layui-table" >
				<tr>
					...
					<input type="button"	class="layui-btn layui-btn-primary layui-border-blue"  value="清空" onclick="deleteFile('myFile_1')" style="width:64px;"/></td>
				</tr>
				<tr>
				<td>2.</td>
					<td><input type="file" id="myFile_2" name="myFile_2"/></td>
					<td><input class="layui-btn layui-btn-primary layui-border-blue" type="button" value="清空" onclick="deleteFile('myFile_2')" style="width:64px;"/></td>
				</tr>
				<tr>
				<td>3.</td>
					<td><input type="file" id="myFile_3" name="myFile_3"/></td>
					<td><input  class="layui-btn layui-btn-primary layui-border-blue"  type="button" value="清空" onclick="deleteFile('myFile_3')" style="width:64px;"/></td>
				</tr>
				<tr>
				<td>4.</td>
					<td><input type="file" id="myFile_4" name="myFile_4"/></td>
					<td><input class="layui-btn layui-btn-primary layui-border-blue" type="button" value="清空" onclick="deleteFile('myFile_4')" style="width:64px;"/></td>
				</tr>
				<tr>
				<td>5.</td>
					<td><input type="file" id="myFile_5" name="myFile_5"/></td>
					<td><input class="layui-btn layui-btn-primary layui-border-blue" type="button" value="清空" onclick="deleteFile('myFile_5')" style="width:64px;"/></td>
				</tr>
			</table>
		</form>
		</div>
