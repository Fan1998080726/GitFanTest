...
<script type="text/javascript" src="<%=path %>/jsp/project/realView/realViewList.js"></script>

</head>
<body>
	<div class="main">
	<div class="breadcrumb">当前位置：三维实景</div>
		<div class="main3" style="padding:10px;">
			...
			<form id="form" method="post">
	            ...
	            <tbody>
	            	<c:forEach items="${list}" var="realView" varStatus="stauts">
		              <tr ondblclick="showDetail('${realView.realId }')" <c:if test="${stauts.count%2==1 }">class="odd"</c:if>>
		                <td style="background:#e3f3f9; border-right:1px solid #91abb9;">
		                	<input type="checkbox" value="${realView.realId }" name="selectFlag">
		                </td>
