...
function chaxun(){
	$('#listform1').attr('aciont','message!queryWarninglist.action');
	$('#listform1').submit();
}
</script>
</head>
<body>
<div class="main">
  <div class="breadcrumb">当前位置：报警信息</div>
  ...
  <!--toolbar-->
   <div class="toolbar">
    <form method="post" id="listform1">
      <ul class="clearfix">
        <li>
            <span>报警标题：</span> <input type="text" class="span3" name="title" value="${ title }">
        </li>
        <li>
     ...
     <div class="action">
            <input name="btn_del" type="button" onclick="del(28);" value="" style="background:url(<%=path %>/img/t-delete.png) no-repeat;display:none"/>
    </div>
    <div class="clear"></div>
  </div>
<!--table-->
