...
<!--          <button type="button"	onclick="chaxun()"	 class="layui-btn layui-btn-normal">查询</button> -->
     <div  align="right">
          ...
          <table     class="layui-table" >
            <thead>
              <tr>
                ...
                <th><img src="img/th-img.png"/>发送内容</th>
            	...
            	<c:forEach items="${list}" var="m" varStatus="stauts">
	              <tr <c:if test="${stauts.count%2==1 }">class="odd"</c:if>  >  
	                 ...
	                 <td   >
	           			...
	           			<c:if test="${m.state=='0' }">查看</c:if>
	           			<c:if test="${m.state=='1' }">已查看</c:if>
	           			</a>
					 </td>
...
<script>
function chaxun(){
	$('#prjcheckinfoform').attr("action","toWork!querySendUserNotices.action");
