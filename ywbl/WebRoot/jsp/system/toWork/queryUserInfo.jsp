...
<fieldset class="layui-elem-field layui-field-title" style="margin-top: 20px;">
  <legend>当前位置： 通讯录</legend>
    ...
    <input name="prjname" id="prjname" 
            value="${ prjname }" type="text"  class="layui-input" placeholder="请输入文字...">
      </div>
    ...
    <input name="personname" id="personname" 
            value="${ personname }" type="text"  class="layui-input" placeholder="请输入文字...">
      </div>
          ...
          <table     class="layui-table" >
            <thead>
              <tr>
                ...
                <th><img src="img/th-img.png"/>单位</th>
                <th><img src="img/th-img.png"/>姓名</th>
                <th	 ><img src="img/th-img.png"/>电话</th>
           		<th><img src="img/th-img.png"/>邮箱</th>
              </tr>
            </thead>
            <tbody>
...
<script>
function chaxun(){
	$('#prjcheckinfoform').attr("action","toWork!queryUserInfo.action");
