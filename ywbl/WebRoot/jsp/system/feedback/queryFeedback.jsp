...
function OnFeedback(c_id){
	 ...
	 layer.open({
 		  ...
 		  fixed: true, //不固定
 		  maxmin: true,
 		  content: 'feedback!againFeedback.action?id='+c_id
 		}); 
}
...
<body  style="background-color: white;" >
     ...
     <form  method="post" name="prjcheckinfoform" 	
          ...
          <table     class="layui-table" >
            <thead>
              <tr>
                ...
                <th><img src="img/th-img.png"/>退回说明</th>
...
<%--              </c:if> --%>
            ...
            <tbody>
            	<c:forEach items="${list}" var="m" varStatus="stauts">
	              ...
	              <a  onclick="OnFeedback('${m.id }')"   class="layui-btn layui-btn-normal"	>
	              <i class="layui-icon"  style="font-size: 18px">&#xe666;</i> 
	              重新反馈</a>
...
function chaxun(){
	$('#prjcheckinfoform').attr("action","feedback!queryFeedback.action");
