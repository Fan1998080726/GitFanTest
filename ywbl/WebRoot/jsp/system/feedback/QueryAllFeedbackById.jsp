...
function ExcelFeedBack(id){

 
	location.replace("feedback!ExcelFeedBack.action?id="+id+"&worktime="+'${worktime}');
...
<div class="main">
  <div class="breadcrumb">当前位置：${uname}_日常工作质量考核情况_${worktime} 
<!--   疫情防控检查-项目检查 -->
...
<%--     	         <c:if test=" ${dept_name!='企业用户组' }"> --%>
    ...
    <button type="button"	onclick="ExcelFeedBack('${id}')"	 class="layui-btn layui-btn-normal">导出</button>
          ...
          <table     class="layui-table" >
            <thead>
              <tr>
                ...
                <th><img src="img/th-img.png"/>操作人</th>
                <th><img src="img/th-img.png"/>计分</th>
                <th><img src="img/th-img.png"/>类别</th>
                <th width="30%" ><img src="img/th-img.png"/>原因</th>
                <th><img src="img/th-img.png"/>事项名称</th>
<%--              </c:if> --%>
