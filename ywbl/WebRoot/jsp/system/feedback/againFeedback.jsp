	...
	<script>
			...
			function onFeedback(){
				...
				if($("#statecontent").val()==''){
				 ...
				 layer.confirm('是否确认重新反馈?', {
			        btn: ['确定', '取消']
			    }, function (index, layero) {
					$.ajax({
				        type: "post",
				    	data : $(".layui-form").serialize(),  
				        url: "feedback!SaveAgainBackFeedBack.action",
...
<div align="right"	>
    ...
    <div class="layui-input-block">
       ...
       <textarea placeholder="请输入内容" 	style="width: 99%"	class="layui-textarea" name="feedbackVo.feedback_breaks"	id="feedback_breaks"	>${feedbackVo.feedback_breaks } </textarea>
