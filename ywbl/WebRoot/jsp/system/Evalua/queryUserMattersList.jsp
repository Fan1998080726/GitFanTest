...
function  confirmEvaluaScore(mid,userid){
	 layer.open({
 		  type: 2,
 		  title:'选择指标扣分',
 		 	setOpaqueRate:'1',
 		  ...
 		  fixed: true, //不固定
 		  maxmin: true,
 		  content: 'Evalua!queryUserEvaluaScorePage.action?mid='+mid+"&userid="+userid
 				 //  		  content: 'feedback!queryUserFeedbackMattersById.action'
 		}); 
}

function chaxun(){
	$('#form1').attr("action","Evalua!queryUserMattersList.action");
	$('#form1').submit();
}
...
<!--   <div class="breadcrumb">当前位置：用户事项 -->
...
<!--     </div> -->
  ...
  <!--toolbar-->
    ...
    <div class="layui-inline">
      <label class="layui-form-label">督办事项：</label>
      <div class="layui-input-inline">
        <input name="prjname" id="prjname" value="${ prjname }"
...
<!--          <li> -->
<%--             <span>督办事项：</span><input name="prjname" id="prjname" value="${ prjname }" type="text" class="span3" placeholder="请输入文字..."> --%>
<!--         </li>  -->
          ...
          <table     class="layui-table" >
            <thead>
              <tr>
                ...
                <th><img src="img/th-img.png"/>督办事项</th>
                <th width="10%"><img src="img/th-img.png"/>操作</th>
              </tr>
            </thead>
            <tbody>
            	<c:forEach items="${list}" var="m" varStatus="stauts">
	              <tr <c:if test="${stauts.count%2==1 }">class="odd"</c:if>  >  
	                 ...
	                 <td   >
	                     ...
	                     <button type="button"  
	                      onclick="confirmEvaluaScore('${m.matters_id}','${id }')" 	
