...
function Audit(id){
	 layer.open({
		  ...
		  fixed: true, //不固定
		  maxmin: true,
		  content: 'delay!AudtiDelay.action?id='+id
		}); 
}
          ...
          <table     class="layui-table" >
            <thead>
              <tr>
                ...
                <th><img src="img/th-img.png"/>申请人</th>
                <th><img src="img/th-img.png"/>申请处室</th>
            ...
            <tbody>
            	<c:forEach items="${list}" var="m" varStatus="stauts">
	              <tr <c:if test="${stauts.count%2==1 }">class="odd"</c:if>  >  
	                 ...
	                 <td   >
	                 	     <button type="button"	onclick="Audit('${m.id}')"	 class="layui-btn layui-btn-normal">
