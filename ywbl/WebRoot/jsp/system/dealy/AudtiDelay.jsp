...
<%--   <link href="<%=path %>/css/zj-skin.css" rel="stylesheet" type="text/css" />   --%>
	...
	<script>
			...
			function audit(str){
				 ...
				 layer.confirm('是否确认确认审核?', {
			        btn: ['确定', '取消']
			    }, function (index, layero) {
					$.ajax({
				        type: "post",
				    	data : $(".layui-form").serialize(),  
				        url: "delay!SaveDelayState.action?str="+str,
...
<body  style="background-color: white;" >
  ...
  <input type="hidden"  name="delayVo.inittime"	 value="${delayVo.inittime }"  />
...
<%-- 					 <input type="button" value="删除"	 class="layui-btn layui-btn-normal" onclick="delFile('${m.cf_id }',this);" style="width:50px;"/> --%>
  ...
  <div class="layui-form-item layui-form-text">
    ...
    <div class="layui-input-block">
      <textarea placeholder="请输入内容"	style="height:30px"	 class="layui-textarea" name="delayVo.statecontent"></textarea>
    </div>
  </div>
   ...
   <div align="center"	>
    <button type="button"   onclick="audit('1')" 	class="layui-btn layui-btn-normal">通过</button>
        &nbsp;&nbsp;&nbsp;&nbsp;
            <button type="button"   onclick="audit('2')" 	class="layui-btn layui-btn-normal">退回</button>
        &nbsp;&nbsp;&nbsp;&nbsp;
</div>
