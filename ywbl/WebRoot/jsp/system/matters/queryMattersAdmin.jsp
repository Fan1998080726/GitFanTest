...
<!-- 	                 保存时 -->
				...
				<a  href="matters!updateMattersPage.action?mattersVo.id=${m.id }"  class="layui-btn layui-btn-normal">
...
<!-- 				提前办结了 -->
	           <c:if test="${m.state=='06'}">
				  ...
				  <button type="button" class="layui-btn layui-btn-disabled">已办结2</button>
