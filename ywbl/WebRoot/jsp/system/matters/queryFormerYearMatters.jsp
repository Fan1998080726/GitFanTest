...
<!-- </fieldset> -->
    ...
    <div class="layui-inline">
      ...
      <div class="layui-input-inline">
        <input type="text" class="layui-input"	 value="${yearVal}"	name="yearVal"
          ...
          <table     class="layui-table" >
            <thead>
              <tr>
                ...
                <th><img src="img/th-img.png"/>进展情况</th>
...
function chaxun(){
	$('#prjcheckinfoform').attr("action","matters!queryFormerYearMatters.action");
	$('#prjcheckinfoform').submit();
}
function ExcelMatters(){
	$('#prjcheckinfoform').attr("action","matters!ExcelOldYearMatters.action");
	$('#prjcheckinfoform').submit();
}
function del(PrjNum) {
