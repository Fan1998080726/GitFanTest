...
<body>
<div class="main">
  <div class="breadcrumb">当前位置：材料出库管理</div>
   <div class="main3">
  ...
  <!--toolbar-->
   <div class="toolbar">
    ...
    <div class="action">
    <input type="button" name="btn_add" onclick="addMaterialOutPage();" value="" style="background:url(<%=path %>/img/08.png) no-repeat;display:none"/>
          ...
          <table class="table table-striped table-bordered table-condensed">
            ...
            <c:forEach items="${list}" var="ma" varStatus="stauts">
	              <tr <c:if test="${stauts.count%2==1 }">class="odd"</c:if>>
	                ...
	                <td>${ ma.ma_num }</td>
	                <td>${ ma.ma_unit }</td>
	                <td>${ ma.ma_apply_date }</td>
	                <td>${ ma.ma_apply_user }</td>
	                <c:if test="${ ma.ma_flag == 0 }">
