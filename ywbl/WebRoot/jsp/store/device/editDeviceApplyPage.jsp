			...
			<form id="form" class="registerform" action="device!updateDeviceApply.action">
				...
				<table
					...
					<tr>
						...
						<td style="width:25%;">
							<input type="text" id="mda_name" name="deviceApply.mda_name" value="${deviceApply.mda_name}" class="inputxt"
					...
					<tr>
						...
						<td><input type="text" readonly="readonly" value="${deviceApply.mda_apply_date}" onclick="$.calendar();"
							id="mda_date" name="deviceApply.mda_apply_date" class="inputxt" datatype="*1-20" nullmsg="请选择日期！"  errormsg="请选择日期！" />
					...
					<tr>
						...
						<td>
							...
							<div class="Validform_checktip">单价不可为空！</div>
						</td>
						<th> 描述:</th>
						<td>
