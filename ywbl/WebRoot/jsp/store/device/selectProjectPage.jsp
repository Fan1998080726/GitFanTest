...
//<!--
	function chaxun() {
		...
		$('#userform').attr("action", "device!selectProjectPage.action");
		$('#userform').submit();
	}
	
	function getProject(){
		var pro_id=$('input[name=selectFlag]:checked');
		$.closeDialog(pro_id.val());
	}
...
<form method="post" id="userform">
      <ul class="clearfix">
        ...
        <input type="submit" value="" onclick="getProject();" style="background:url(img/t-save.png) no-repeat; width:64px; height:25px; border:none; margin:10px; float:right;"/>
      </ul>
