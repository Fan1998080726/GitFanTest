...
<body>
	<div class="main">
		...
		<div class="main5">
			...
			<!--form-->
			<form id="form" class="registerform" action="device!addDeviceApply.action">
				...
				<table
					...
					<tr>
						...
						<td style="width:25%;">
							<input type="text" id="mda_name" name="deviceApply.mda_name" class="inputxt"
									datatype="*1-20" errormsg="设备名不可为空！" />
							<div class="Validform_checktip">设备名不可为空！</div>
						</td>
						
						<th style="width:25%;"><span class="need">*</span> 数量:</th>
						<td style="width:25%;">
							<input type="text" id="mda_num" 
									name="deviceApply.mda_num" class="inputxt"
					...
					<tr>
						...
						<td>
							<input type="text" id="mda_unit"
									name="deviceApply.mda_unit" class="inputxt"
					...
					<tr>
						<th><span class="need">*</span> 单价(元/天):</th>
						<td>
							<input type="text" id="mda_price" 
									name="deviceApply.mda_price" class="inputxt"
									datatype="/^\d{1,8}(?:\.\d{0,2})?$/" errormsg="单价不可为空,可有两位小数八位整数！" />
							<div class="Validform_checktip">单价不可为空,可有两位小数八位整数！</div>
						</td>
						<th> 描述:</th>
						<td>
							<input type="text" id="mda_describe" name="deviceApply.mda_describe" class="inputxt"
									datatype="*1-100" ignore="ignore" errormsg="描述不可超过100个字符！" />
									<div class="Validform_checktip">描述可为空，但不能超过100字符！</div>
						</td>
					</tr>
				</table>
			</form>
