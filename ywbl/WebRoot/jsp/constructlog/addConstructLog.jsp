...
<body>
	<div class="main">
		...
		<!--toolbar-->
			...
			<!--form-->
			<form id="form" action="constructlog!addConstructLog.action" class="registerform" method="post">
			...
			<!--table-->		
				<table class="table2 table2-striped table2-bordered table2-condensed table2-down">
				  <tr>
				    ...
				    <td style="width:65%;"><input type="text" id="sc_title" class="inputxt" name="constructLog.cl_date" onclick="$.calendar();" datatype="*1-100" nullmsg="请添加时间信息" readonly="readonly" /></td>
				  </tr>
				  <tr>
				  ...
				  <tr>
				    <th>上报描述：</th>
				    <td><textarea id="sc_remark" name="constructLog.cl_describe" rows="5" cols="5"></textarea></td>
				  </tr>
				</table>
			</form>
