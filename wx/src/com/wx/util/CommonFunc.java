...
//    	
//    	String str = "20185";
//    	String strs = str.substring(0,4);
//    	//System.out.println(strs);
    	/*20181
    	sewageNumYear= sewageVo.getSewageNum().substring(0, 4);
		sewageNumNumber=sewageVo.getSewageNum().substring(5, sewageVo.getSewageNum().length());
		*/
//		//System.out.println("20181".substring(4, "20181".length()));
    }
