	   ...
	   var curl ="";
	         ...
	         setTimeout(function (){
	        	   	location.replace(curl+"&prjId="+prjId
	        	   			...
	        	   			+"&personOne="+document.getElementById("personOne").value
...
<option value="其他单位" >其他单位</option>
    	...
    	<li><input type="text" class="input1" id="name" name="name" value="${name}" placeholder="请输入姓名" ${readonlyOp}/></li>
    	<li><input type="text" class="input1" id="cardnum" name="cardnum" value="${cardnum}"  placeholder="请输入您的身份证号" ${readonlyOp}/></li>
