...
<!--         <div class="item-title item-floating-label">企业月报表(1-3)月</div> -->
         ...
         <c:if test="${infoVo.type=='通知'}">
         
                 <li class="item-content item-input">
        <div class="item-inner">
<!--         <div class="item-title item-floating-label">企业月报表(1-3)月</div> -->
         <div class="item-input-wrap">
         内容：${infoVo.noticeinfo }
           <span class="input-clear-button"></span></div></div>
          </li>
         
         </c:if>
         <c:if test="${infoVo.type=='文件'}">
...
<!--         <div class="item-title item-floating-label">企业月报表(1-3)月</div> -->
        ...
        文件：
         ...
         <a href="http://192.168.110.14/download/${infoVo.filename }" >（下载） </a>
           <span class="input-clear-button"></span></div></div>
          </li>
        ...
        <a href="#" onclick="javascript:history.back(1);"/><div class="button button-large button-fill bigBtn">返回</div> </a>
        </form>
        <!----></div></div>
    </div></div>
