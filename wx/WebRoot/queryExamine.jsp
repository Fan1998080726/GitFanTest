...
<!-- 	        <div class="button button-large button-fill bigBtn" onclick="serch();">查询</div> -->
 <table width="80%" border="1" align="center" cellpadding="0" cellspacing="0">
   <tr>
     <td height="28" bgcolor="#F0F0F0"><div align="center" class="STYLE2">项目名称</div></td>
   </tr>
        <c:forEach items="${list }" var="m">
		     	<tr>
		   
		     			<td><div align="center">	<a href="WxServlet?opflag=queryTable&pid=${m.id }">${m.prjname}</a></div></td>
		     	</tr>
