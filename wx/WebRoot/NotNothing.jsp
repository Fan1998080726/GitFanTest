...
<div id="app" class="framework7-root">
    ...
    <div class="page loginPage page-current" data-name="login">
        ...
        <div class="titleBox" align="center"> 注册检查人员
 </div> 
         <form name="form1"  
         class="layui-form" 
...
<!--         class="item-content item-input" -->
          ...
          <li >
<%--         <b>  检查人姓名${openid }：</b> --%>
          <input name="username"  id="username"  type="text"   placeholder="请输入检查人姓名"  required="required"    >
          </li>
          </br>
          <li >
<!--         <b>  检查人身份证号：</b> -->
          <input name="idcard"	id="idcard"	 type="text"   placeholder="请输入检查人身份证号"  required="required"    >
          </li>
             </br>
          <li >
<!--         <b>  检查人手机号：</b> -->
          <input name="phone" 	id="phone"	type="text"   placeholder="请输入检查人手机号"  required="required"    >
          </li>
      
        </br>
           </ul>
              </div> 
                      <div class="button button-large button-fill bigBtn"  onclick="fnConfirm()" >注&nbsp;&nbsp;&nbsp;册 </div> 
        </form>
      </div></div>
    </div></div>
...
// 	 alert("creditCode="+creditCode);
	 ...
	 var  openid='${openid}';
	   ...
	   $.ajax( {
	        type : 'POST',
	        url : 'WxServlet?opflag=regJlCheckPerson',
	        dataType:"json",
	        data : {username:username,openid:openid,idcard:idcard,phone:phone,creditCode:creditCode},
	        success : function(msg) {
// 	        	alert("msg="+msg);
	        	alert("提交成功，请等待监理企业进行人员确认！");
	    		wx.closeWindow();
	        } 
	    });
