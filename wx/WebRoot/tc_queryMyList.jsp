...
<div class="view view-main safe-areas">
    <div class="page loginPage page-current" data-name="login">
        ...
        <div class="titleBox">我的账户信息</div> 
         <form id="form1" class="registerform" action="WxServlet?opflag=serchAdmin" method="post">
        <div class="list  no-hairlines-md">
		          <ul>
		          	<li class="sli2">单位名称:${userInfo.buildCorpCode }</li>
		          	<li>账号:${userInfo.login_id }</li>
		          	<li>姓名:${userInfo.user_name }</li>
		          	<li>身份证号:${userInfo.memo }</li>
		          	<li>手机号:${userInfo.phone }</li>
		          	<li>监管平台网址:221.207.229.44:7777</li>
		          </ul>
    </form>
