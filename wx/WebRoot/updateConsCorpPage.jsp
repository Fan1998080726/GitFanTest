...
<div id="app" class="framework7-root">
    ...
    <div class="page loginPage page-current" data-name="login">
        ...
        <div class="titleBox">施工企业月报表</div> 
...
<!--         <div class="item-title item-floating-label">企业月报表(1-3)月</div> -->
         ...
         <input name="roadMonth" type="text" placeholder="企业月报表(1-3)月" pattern=".{5,}" validate="" data-error-message="企业月报表(1-3)月" required="required">
...
<!--           <div class="item-title item-floating-label">从业人数</div>  -->
          <div class="item-input-wrap"><input  name="personCount"  type="text" placeholder="请输入从业人数" validate=""  required="required"> <span class="input-clear-button"></span>
          </div></div></li>
          
           <li class="item-content item-input">
          <div class="item-inner">
<!--           <div class="item-title item-floating-label">合同金额(万元)</div>  -->
          <div class="item-input-wrap"><input  name="roadMoney"  type="text" placeholder="请输入合同金额(万元)" validate=""  required="required"> <span class="input-clear-button"></span>
          </div></div></li>

           <li class="item-content item-input">
          <div class="item-inner">
<!--           <div class="item-title item-floating-label">完成产值(万元)</div>  -->
          <div class="item-input-wrap"><input  name="poadValue"  type="text" placeholder="请输入完成产值(万元)"   validate=""  required="required"> <span class="input-clear-button"></span>
          </div></div></li>
          
           <li class="item-content item-input">
          <div class="item-inner">
<!--           <div class="item-title item-floating-label">承揽工程数量(个)</div>  -->
          <div class="item-input-wrap"><input  name="roadProjectCount"  type="text" placeholder="请输入承揽工程数量(个)" validate=""  required="required"> <span class="input-clear-button"></span>
          </div></div></li>
          
           <li class="item-content item-input">
          <div class="item-inner">
<!--           <div class="item-title item-floating-label">新开工面积(米)</div>  -->
          <div class="item-input-wrap"><input  name="roadNewArea"  type="text" placeholder="请输入新开工面积(米)" validate=""  required="required"> <span class="input-clear-button"></span>
          </div></div></li>
